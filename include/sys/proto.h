...
PUBLIC  void    print_font(char *vram, int xsize, int x, int y, char c, char *font);
PUBLIC  void    print_string(char *vram, int xsize, int x, int y, char c, unsigned char *s);
PUBLIC  void    printString(int x, int y, char c, unsigned char *s, ...);
/* vsprintf.c */
