...
PRIVATE	void w_copy_1(CONSOLE *con,unsigned int dst,unsigned int src);
...
void putfont(int x,int y,char ch)
{
	...
	y=y*FONT_HEIGHT;
	boxfill8(SCREEN_WIDTH,15,x,y,x+FONT_WIDTH,y+FONT_HEIGHT);
	putfonts8_char(x,y,7,ch);
}
/*****************************************************************************
 *                                out_char
 *****************************************************************************/
